<nav>
    <div class="nav-wrapper">
        ...
        <!-- ============================================================== -->
        <ul class="right">
            <li class="lang-dropdown"><a class="dropdown-trigger" href="javascript: void(0);" data-target="lang_dropdown"><i class="flag-icon flag-icon-ps"></i></a>
                <ul id="lang_dropdown" class="dropdown-content">
                    ...
                    <li>
                        <a href="#!" class="grey-text text-darken-1">
                            <i class="flag-icon flag-icon-sa"></i> SUA</a>
                    </li>
                    <li>
                        <a href="#!" class="grey-text text-darken-1">
                            <i class="flag-icon flag-icon-jo"></i> Jorden</a>
                    </li>
                    <li>
                        <a href="#!" class="grey-text text-darken-1">
                            <i class="flag-icon flag-icon-qa"></i> Qater</a>
                    </li>
                </ul>
            </li>
            <!-- ============================================================== -->
